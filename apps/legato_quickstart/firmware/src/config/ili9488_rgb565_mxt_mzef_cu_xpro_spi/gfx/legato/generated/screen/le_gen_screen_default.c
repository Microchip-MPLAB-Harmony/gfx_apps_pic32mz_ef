...
leResult screenShow_default(void)
{
    ...
    default_ImageWidget0->fn->setPosition(default_ImageWidget0, 5, 4);
    ...
    default_ImageWidget1->fn->setPosition(default_ImageWidget1, 75, 80);
    ...
    default_ButtonWidget0->fn->setPosition(default_ButtonWidget0, 83, 346);
    ...
    default_LabelWidget0->fn->setPosition(default_LabelWidget0, 52, 280);
    ...
    default_LabelWidget1->fn->setPosition(default_LabelWidget1, 127, 280);
    ...
    default_LabelWidget2->fn->setPosition(default_LabelWidget2, 202, 280);
